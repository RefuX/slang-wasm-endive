 ...
 * {@link SlangCompiler.SessionBuilder#target(io.github.refux.slangwasm.enums.Target, String)}).
 * Use this enum (via {@link
 * SlangCompiler.SessionBuilder#target(io.github.refux.slangwasm.enums.Target, VulkanVersion)}
 * or {@link SlangCompiler.TargetSpec#of(io.github.refux.slangwasm.enums.Target, VulkanVersion)})
